...
function Team () {
  return (
    <section>
      ...
      <div className="members columns mb-4">
          ...
          <div class="card">
            <div class="card-content">
              <div class="media">
                <div class="media-left">
                  <figure class="image is-48x48">
                    <img src="https://media-exp1.licdn.com/dms/image/C5635AQFkxx2nDqnDlw/profile-framedphoto-shrink_800_800/0/1614697137195?e=1647720000&v=beta&t=CwGXaNUJdGZPmNRusj5QBKD51dykppe-wG1hfgrfEvA" alt="Placeholder image" />
                  </figure>
                </div>
                <div class="media-content">
